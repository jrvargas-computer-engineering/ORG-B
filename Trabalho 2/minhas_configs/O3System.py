...
class L1_Cache(Cache):
    ...
    size = '32kB'   #Parametro 1
    assoc = 4       #Parametro 2
    tag_latency = 1 #Parametro 3
    data_latency = 1
    response_latency = 2
    mshrs = 4
    tgts_per_mshr = 20
...
############################################################
    ...
    numROBEntries = 40 #168 # Tamanho do reorder buffer, em qtd. de
                        # micro-ops
    LQEntries = 24 # Tamanho da fila de loads, em qtd. de micro-ops
    SQEntries = 24 # Tamanho da fila de stores, em qtd. de micro-ops
